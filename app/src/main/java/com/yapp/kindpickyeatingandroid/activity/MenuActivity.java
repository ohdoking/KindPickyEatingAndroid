...
import com.yapp.kindpickyeatingandroid.util.DrawableCalendarEvent;
//import com.yapp.kindpickyeatingapp.DrawableCalendarEvent;
//import com.yapp.kindpickyeatingapp.DrawableEventRenderer;
//import com.yapp.kindpickyeatingapp.R;
...
//        mAgendaCalendarView.addEventRenderer(new DrawableEventRenderer());
    ...
    private void mockList(List<CalendarEvent> eventList) {
        ...
        BaseCalendarEvent event1 = new BaseCalendarEvent("산채비빔밥", "A wonderful journey!", "김포한정식",
        ...
        BaseCalendarEvent event2 = new BaseCalendarEvent("감자 샐러드", "A beautiful small town", "도스마스",
        ...
        DrawableCalendarEvent event3 = new DrawableCalendarEvent("도토리묵", "", "김밥천국",
